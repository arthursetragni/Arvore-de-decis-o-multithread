...
class DecisionTree {
    public:
        ...
        // Isso acontece se os dados restantes forem ambíguos 
        // (atributos idênticos, mas classes diferentes).
        // Nesses casos, o nó DEVE se tornar uma folha.
        if (selectedAttrIndex == -1) {
            tree[nodeIndex].isLeaf = true;
            // Rotula com a classe majoritária dos dados restantes
